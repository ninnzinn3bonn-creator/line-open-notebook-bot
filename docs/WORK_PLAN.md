...
1. 有人希望と高リスク確定要求の検索前ルーティング
2. handoff recordのSQLite保存、重複防止、管理API
3. 有人案内文・電話番号・受付時間・有人チャットURLの設定化
4. 42問版Datasetへ有人希望・予約確定要求を追加
5. 同時3件、10件Burst、同一ユーザー3連投の自動試験
6. Provider停止、Timeout、再起動復旧の再現スクリプトと記録様式
7. PoC提出レポートの骨組み作成
